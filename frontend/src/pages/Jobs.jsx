    ...
    if (opp.type === "job"){
      return(
        (open && (<div className={` flex justify-between bg-[rgba(69,69,69,0.5)] hover:bg-[rgba(89,89,89,0.5)] text-left py-2 text-blue-500 w-xs md:w-xl`}>
          <div className="flex ">
            <div>
              <img src={`${mediaUrl(opp.company_logo_url)}`} className="max-h-10 px-3"></img>
            </div>
            <div>
      ...
      return(
        (open && (<div className={` flex justify-between bg-[rgba(69,69,69,0.5)] hover:bg-[rgba(89,89,89,0.5)] text-left py-2 text-blue-500 w-xs md:w-xl`}>
          <div className="flex ">
            <div>
              <img src={`${mediaUrl(opp.org_logo)}`} className="max-h-10 px-3"></img>
            </div>
            <div>
